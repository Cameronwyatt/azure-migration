##########################
#
# Get the available resource groups that are attached to our account
#
##########################
require 'json'
...
begin
  ...
  resource_groups = Azure::Armrest::ResourceGroupService.new(config)
  names = resource_groups.list.map {|x| [x['name'],x['name']]}
