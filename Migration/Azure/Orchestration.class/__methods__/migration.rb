begin
  ...
  $evm.instantiate("/Jason/ConfigurationManagement/AnsibleTower/Operations/JobTemplate/seal_vm?job_template_name=seal_vm")
...
Select-AzureRmProfile -Path "C:\\creds\\azure.txt"
Add-AzureRmVhd -Destination 'https://#{sa}.blob.core.windows.net/upload/#{name}.vhd' -LocalFilePath "C:\\images\\#{name}\\disk-0.vhd" -ResourceGroupName #{rg}
$result 
